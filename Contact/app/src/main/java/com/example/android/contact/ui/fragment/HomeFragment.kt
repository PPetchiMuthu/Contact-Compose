...
import com.example.android.contact.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.cardPersonal.setOnClickListener {
            findNavController().navigate(R.id.action_navigation_home_to_personalFragment)
        }
        ...
        binding.cardGroups.setOnClickListener {
            findNavController().navigate(R.id.action_navigation_home_to_navigation_groups)
        }
        return root
    }
